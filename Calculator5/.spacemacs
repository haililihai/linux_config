...
values."
  (setq-default
   ...
   '(
     ...
     ;; version-control
     ;;(eyebrowse :variables
     ;;           eyebrowse-display-help nil)  ;; workspace
     (colors :variables
...
you should place your code here."
  ...
  ;; WenQuanYi 13.5 Consolas 12.5 DejaVu 11.5
  ;; WenQuanYi 10.5 Consolas 10
  ;; WenQuanYi 12 DejaVu 10
  (defun x-font()
  (interactive)
  (set-face-attribute
   'default nil
  ...
  (dolist (charset '(kana han symbol cjk-misc bopomofo))
    (set-fontset-font
     ...
     ;; (font-spec :name "-ZYEC-KaiTi-normal-normal-normal-*-*-*-*-*-*-0-iso10646-1"
                :weight 'normal
                :slant 'normal
                :size 13.5))))
